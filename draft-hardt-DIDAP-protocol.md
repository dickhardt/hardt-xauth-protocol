...
Each instance of a Client can generate it's own asymmetric key pair, and keep its private key secret. 

All clients can authenticate themselves. ???

to be done

10 years later, ris eof mobile, faster processors.

Identity and Authorization are often performed by the same system.

Single interaction with the user

Rise of mobile phones

Web Cryptography APIs, a single page app can generate a - no public Clients. 
